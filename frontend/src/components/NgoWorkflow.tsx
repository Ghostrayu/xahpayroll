...
const NgoWorkflow: React.FC = () => {
  const steps = [
    ...
    {
      number: 6,
      title: 'AUTOMATIC SETTLEMENT ON CLOSURE',
      description: 'WHEN PAYMENT CHANNEL CLOSES, WORKERS RECEIVE ALL ACCUMULATED EARNINGS IN SINGLE TRANSACTION FROM ESCROW',
      icon: '⚡'
    }
  ]
