...
const NgoWorkflow: React.FC = () => {
  const steps = [
    ...
    },
    {
      ...
      description: 'WORKERS SUBMIT CLOSURE REQUESTS VIA DASHBOARD. REVIEW ACCUMULATED BALANCES AND APPROVE REQUESTS.',
      icon: '✅'
    },
    {
      number: 7,
      title: 'EXECUTE CLOSURE TRANSACTION',
      description: 'EXECUTE PAYMENTCHANNELCLAIM TRANSACTION TO RELEASE WORKER EARNINGS. SETTLEDELAY PROTECTS WORKERS DURING TRANSITION.',
      icon: '⚡'
    }
  ]
