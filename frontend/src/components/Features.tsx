...
const Features: React.FC = () => {
  const features: Feature[] = [
    ...
    },
    {
      ...
      description: 'COMPLETE PAYMENT HISTORY, WORK SESSIONS, AND CHANNEL DETAILS EXPORTABLE AS PDF REPORTS. WORKERS AND NGOS CAN DOWNLOAD COMPREHENSIVE RECORDS FOR ACCOUNTING AND COMPLIANCE.',
    },
  ]
