...
### FOR EMPLOYERS/NGOS
1. CONNECT YOUR XAH WALLET TO THE PLATFORM (MUST BE DIFFERENT FROM ANY EMPLOYEE WALLET)
2. COMPLETE YOUR ORGANIZATION PROFILE
3. ACCEPT THE TERMS OF SERVICE
4. ADD WORKERS TO YOUR ORGANIZATION
5. FUND THE ESCROW WALLET WITH XAH
6. CONFIGURE HOURLY RATES FOR EACH WORKER
7. MONITOR REAL-TIME PAYMENT ACTIVITY AND ESCROW BALANCE
8. REVIEW PAYMENT REPORTS AND ANALYTICS
